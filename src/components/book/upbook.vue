    ...
    <div class="atap">
      ...
      <div class="login">
        ...
        <div class="usermake tantan">
            ...
            <span>点击数：</span><input type="text" v-model="click" />
...
export default {
  ...
  created() {
    ...
    this.click = this.$route.params.makedata.click;
    this.img = this.$route.params.makedata.img_url;
    this.author = this.$route.params.makedata.authorID;
